...
<a href="published-paper-admin" class="sidebars"><i class="far fa-newspaper"></i>&nbsp Published Paper</a>
  ...
  <a href="admin-number" class="sidebars"><i class="fas fa-user-shield"></i>&nbsp Admin</a> 
  <a href="add-admin" class="sidebars"><i class="fas fa-user-shield"></i>&nbsp Add New Admin</a>
  <a href="change-password-admin" class="sidebars"><i class="fas fa-unlock-alt"></i>&nbsp Change password</a>
