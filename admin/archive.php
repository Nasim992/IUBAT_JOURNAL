...
<form class="author-form"  method = "post" enctype = "multipart/form-data">
   ...
   <br>
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="exampleFormControlTextarea1" name= "papername"  placeholder ="Enter the Paper Name of this paper " required>
        </div>
        </div>
        <br>
        <div class="input-group">
        <label class="col-sm-2 col-form-label" for="formGroupExampleInput"><b>Author Name:</b></label>
        <div class="col-sm-10">
        <input type="text" class="form-control" id="exampleFormControlTextarea1" name= "authorname"  placeholder ="Enter the Authorname of this paper" required>
        </div>
        </div>
        <br>
        <div class="input-group">
        ...
        <div class="col-sm-10">
        <textarea class="form-control" id="exampleFormControlTextarea1" name= "abstract" rows="10" placeholder ="Write the Abstract of this paper" required></textarea>
        </div>
        </div>
        <br>
        <div class="input-group">
        <label class="col-sm-2 col-form-label" for="formGroupExampleInput"><b>Published Date :</b></label>
        <div class="col-sm-10">
        <input type="date" class="form-control" id="exampleFormControlTextarea1" name= "publisheddate"  required>
        </div>
        </div>
        <br>
        </div>
        ...
        <div class="input-group">
        <label class="col-sm-8 col-form-label" for="formGroupExampleInput"><b>Upload the paper </b></label>
        <div class="col-sm-4">
