           ...
           ?>]</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        <h3 style="font-size:17px" class="text-dark btn btn-info btn-block"><b
                                class="text-white"><i>Send Associate Editor Request </i></b></h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        <h3 style="font-size:17px" class="text-dark btn btn-info btn-block"><b
                                class="text-white"><i>Send Academic Editor Request </i></b></h3>
                        <!-- <hr class="bg-success"> -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        ...
                        <h3 style="font-size:17px" class="btn btn-info btn-block"><b><i>Send Review Request to this
                                    author</i></b></h3>
                        <button onclick="handleOutsideReviewer()" class="btn btn-block  text-info"><i
                                class="fas fa-edit"></i> Write email if not available below</button> <br>
                        <!-- -------------------Outside Reviewer selection ------------------------------ -->
                        <div id="handleoutsidereviewer">
                            <form method="post">
                                <div class="input-group">
                                    <label class="col-sm-2 col-form-label"
                                        for="formGroupExampleInput"><b>Email:</b></label>
                                    <div class="col-sm-10">
                                ...
                                <div>
                                    <button class="btn btn-sm btn-info btn-block mr-4" name="select-reviewer-outside"
