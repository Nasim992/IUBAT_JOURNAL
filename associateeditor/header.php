        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item hidden active" title="Dashboard">
                ...
                <li class="nav-item hidden active" title="reviewer">
                    <span class="navbar-text"><a href="editordetails" class="sidebars nav-link"><i
                                class="fas fa-users-cog"></i>&nbsp Academic Editor</a></span>
                </li>
                <li class="nav-item hidden active" title="reviewer">
                ...
                <li class="nav-item hidden active" title="Feedback">
                    <span class="navbar-text"><a href="reviewedpaper" class="sidebars nav-link"><i
                                class="fas fa-comments"></i>&nbsp Reviewed Paper</a></span>
                </li>
                <li class="nav-item hidden active" title="Feedback">
                    <span class="navbar-text"><a href="rfeedback" class="sidebars nav-link"><i
                                class="fas fa-comments"></i>&nbsp Reviewer Feedback</a></span>
                </li>
                <li class="nav-item hidden active" title="Feedback">
                    <span class="navbar-text"><a href="efeedback" class="sidebars nav-link"><i
                                class="fas fa-comments"></i>&nbsp Editor Feedback</a></span>
                </li>
