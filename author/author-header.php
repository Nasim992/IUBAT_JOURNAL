        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto ul-nav">
                ...
                <li class="nav-item hidden active" title="Dashboard">
                    <span class="navbar-text"><a href="dashboard" class="sidebars nav-link"><i
                                class="fas fa-tachometer-alt"></i>&nbsp Dashboard</a></span>
                </li>

                <li class="nav-item hidden active" title="Upload paper">
                    <span class="navbar-text"><a href="uploadpaper" class="sidebars nav-link"><i
                                class="fas fa-upload"></i>&nbsp Upload Paper</a></span>
                </li>

                <li class="nav-item hidden active" title="Paper Status">
                    <span class="navbar-text"><a href="paperstatus" class="sidebars nav-link"><i
                                class="fas fa-exclamation-circle"></i>&nbsp Paper Status</a></span>
                </li>
                ...
                <li class="nav-item hidden active" title="Update your profile">
                    <span class="navbar-text"><a href="updateprofile" class="sidebars nav-link"><i
                                class="fas fa-exclamation-circle"></i>&nbsp Update Profile</a></span>
                </li>
                <li class="nav-item hidden active" title="Change your password">
                    <span class="navbar-text"><a href="changepassword" class="sidebars nav-link"><i
                                class="far fa-newspaper"></i>&nbsp Change Password</a></span>
                </li>
                <li class="nav-item hidden active" title="Under Review">
                    <span class="navbar-text"><a href="reviewerstatus" class="sidebars nav-link"><i
                                class="far fa-newspaper"></i>&nbsp Reviewed paper</a></span>
                </li>
