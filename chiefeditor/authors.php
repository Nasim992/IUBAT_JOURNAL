...
<a class="text-danger" href="delete-author.php?id=<?php echo htmlentities($result->id);?>"onclick="return confirm('Are you sure you want to delete this Author?');"><i class="fas fa-trash-alt" title="Delete"></i></a>
