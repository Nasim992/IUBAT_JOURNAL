...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2021 at 08:58 AM
...
(2, 'admin', 'Shah', '5fb6e2a60c9da41e0a94fe6157ddb93f', 'admin@gmail.com', '099343');
...
CREATE TABLE `archive` (
  `id` int(11) NOT NULL,
  `versionissue` int(255) DEFAULT NULL,
...
(1, 'Prof Dr. Md Monirul Islam', '5fb6e2a60c9da41e0a94fe6157ddb93f', 'chief@gmail.com', '9999999');

-- --------------------------------------------------------

--
-- Table structure for table `chieffeedback`
--

CREATE TABLE `chieffeedback` (
...
CREATE TABLE `editortable` (
  ...
  `feedbackfile` varchar(100) DEFAULT NULL,
...
CREATE TABLE `reviewertable` (
  ...
  `feedbackdate` varchar(1000) DEFAULT NULL,
  `action` int(11) DEFAULT NULL,
  `accepted` int(11) DEFAULT NULL,
...
--
-- Indexes for table `chieffeedback`
--
ALTER TABLE `chieffeedback`
